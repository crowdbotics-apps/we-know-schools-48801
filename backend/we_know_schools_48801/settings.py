"""
Django settings for we_know_schools_48801 project.
...
ROOT_URLCONF = 'we_know_schools_48801.urls'
...
WSGI_APPLICATION = 'we_know_schools_48801.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "we know schools Support <support@we-know-schools-48801.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "we_know_schools_48801 API",
    "DESCRIPTION": "API documentation for we_know_schools_48801 App",
    "VERSION": "v1",
}
